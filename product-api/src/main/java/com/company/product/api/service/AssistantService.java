...
public class AssistantService {
    ...
    private static final String SYSTEM_PROMPT = """
            ...
            4) Строго следуй ограничениям пользователя (бюджет, тип товара, категория, размеры и т.п.). Если подходящих товаров нет — так и скажи и попроси расширить условия.
            ...
            7) В рекомендациях обязательно указывай: productId, sku, цену и остаток.
